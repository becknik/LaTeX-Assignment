...
\usepackage[resetfonts]{cmap}	% \usepackage[noTeX]{mmap} uniting cmap and utf-8 math, but somehow build fails
...
\usepackage{stmaryrd}	% For the lightning!
%\usepackage{hyperref}
\usepackage{csquotes}	% Quoting with \eqnquote{}, provides advanced facilities for inline and display quotations
